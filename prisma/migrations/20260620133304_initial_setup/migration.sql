...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('COD', 'BKASH', 'CARD', 'NAGAD');

-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PENDING', 'PROCESSING', 'PAID', 'FAILED', 'CANCELLED', 'REFUNDED', 'PARTIALLY_REFUNDED', 'COD_PENDING');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('ORDER_PLACED', 'AWAITING_PAYMENT', 'PAYMENT_CONFIRMED', 'PROCESSING', 'CONFIRMED', 'PACKED', 'READY_FOR_SHIPMENT', 'SHIPPED', 'OUT_FOR_DELIVERY', 'DELIVERED', 'CANCELLED', 'RETURN_REQUESTED', 'RETURNED', 'REFUND_PROCESSING', 'REFUNDED', 'FAILED_DELIVERY');

-- CreateEnum
CREATE TYPE "ReturnStatus" AS ENUM ('REQUESTED', 'UNDER_REVIEW', 'APPROVED', 'REJECTED', 'PRODUCT_RECEIVED', 'REFUND_PROCESSING', 'COMPLETED');
...
CREATE TABLE "Product" (
    ...
    "sizeGuide" TEXT,
    "stitchingType" TEXT,
    "customMeasurement" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateIndex
CREATE INDEX "Product_featured_newArrival_bestSeller_idx" ON "Product"("featured", "newArrival", "bestSeller");
...
-- AddForeignKey
ALTER TABLE "OrderAddress" ADD CONSTRAINT "OrderAddress_addressId_fkey" FOREIGN KEY ("addressId") REFERENCES "Address"("id") ON DELETE SET NULL ON UPDATE CASCADE;
